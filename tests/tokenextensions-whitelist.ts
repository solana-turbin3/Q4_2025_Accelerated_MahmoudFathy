...
import { TokenextensionsWhitelist } from "../target/types/tokenextensions_whitelist";
...
describe("whitelist-transfer-hook", () => {
  ...
  const program = anchor.workspace.tokenextensionsWhitelist as Program<TokenextensionsWhitelist>;
